...
class CLS_TEM{
	...
	function listTableTem($strwhere="",$page){
		...
		{	$i++;
			$temid=$rows["tem_id"];	$name=$rows["name"];
			$author=$rows["author"];$author_email=$rows["author_email"]; $author_site=$rows["author_site"];
			echo "<tr name=\"trow\">";
			...
			echo "<td width=\"75\" align=\"center\" >$author_email</td>";
			echo "<td width=\"75\" align=\"center\" >$author_site</td>";
