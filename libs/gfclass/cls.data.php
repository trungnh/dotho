<?php
class CLS_MYSQL{
	var $pro=array("hostname"=>"localhost","username"=>"samhanquoc_igf","password"=>"LSL1dnjz","dataname"=>"samhanquoc_igf");
	//var $pro=array("hostname"=>"localhost","username"=>"root","password"=>"","dataname"=>"samhanquoc");
