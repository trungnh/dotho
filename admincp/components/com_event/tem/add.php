   ...
   <legend><strong><?php echo CDETAIL;?>&nbsp;</strong></legend>
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
		...
		<tr>
			...
			<td>
				<input name="txtthumb" type="text" id="txtthumb" size="50" value="" />
		...
		<tr>
			...
			<td><input type="checkbox" value="1" name="ismenu" id="ismenu" />
			 </td>
        </tr>
        <tr>
			<td align="right" bgcolor="#EEEEEE"><strong><?php echo CPUBLIC;?>&nbsp;</strong></td>
			<td><input name="optactive" type="radio" id="radio" value="1" checked="checked"/>
			  <?php echo CYES;?>
