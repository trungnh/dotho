  ...
  <div class="messagebox"><?php include(THIS_COM_PATH."tem/message.php");?></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
      <tr>
		...
		<select name="cbo_iscan" id="cbo_iscan" onchange="document.frm_list.submit();">
          <option value="all"><?php echo MALL;?></option>
          <option value="1">Quan tâm</option>
          <option value="0">Không quan tâm</option>
          <script language="javascript">
			cbo_Selected('cbo_iscan','<?php echo $iscan;?>');
            </script>
        </select>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
      <tr class="header">
        ...
        <td align="center"><?php echo CCATALOG;?></td>
