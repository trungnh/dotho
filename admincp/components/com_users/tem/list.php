...
<div id="list">
  ...
  <form id="frm_list" name="frm_list" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="5" class="list">
	  ...
	  if($strwhere==''){
	  	$strwhere = "where mem_id not in ('$id') and gmem_id not in ('".$objmember->par_id."','".$objmember->business."')";
	  }else{
	  	$strwhere  = $strwhere." and mem_id not in ('$id') and gmem_id not in ('".$objmember->par_id."','".$objmember->business."')";
	  }
