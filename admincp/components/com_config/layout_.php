...
<?php
$title =''; $desc=''; $key='';$email_contact='';
$footer=''; $contact=''; $banner=''; $gallery='';

include_once("../libs/gfclass/cls.data.php");
include_once("../libs/gfclass/cls.config.php");
$conf = new CLS_CONFIG();
...
if(isset($_POST["web_title"]) && $_POST["web_title"]!="") {
	...
	if($_POST["txtbanner"]!='') 	$banner = addslashes($_POST["txtbanner"]);
	if($_POST["txtgallery"]!='') 	$gallery = addslashes($_POST["txtgallery"]);
	...
	$conf->Desc		=$desc;
	$conf->Key		=$key;
	$conf->EmailContact	=$email_contact;
	$conf->Banner	=$banner;
	...
	//var_dump($row);
	$web_title 		= stripslashes($row["web_title"]);
	$web_desc  		= stripslashes($row["web_desc"]);
	$web_keywords 	= stripslashes($row["web_keywords"]);
...
<form name="frm_action" id="frm_action" action="" method="post">
  <table width="100%" border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
       <td colspan="2" bgcolor="#CCCCCC"><strong>Banner</strong></td></tr>
    <tr>
      <td colspan="2" align="center">
      <textarea name="txtbanner" id="txtbanner" cols="45" rows="5"><?php echo $banner; ?></textarea>
        <script language="javascript">
			var oEdit4=new InnovaEditor("oEdit4");
			oEdit4.width="100%";
			oEdit4.height="100";
			oEdit4.cmdAssetManager ="modalDialogShow('/extensions/editor/innovar/assetmanager/assetmanager.php',640,465)";
			oEdit4.REPLACE("txtbanner");
		</script>
      </td>
    </tr>
    <tr>
       <td colspan="2" bgcolor="#CCCCCC"><strong>Gallery</strong></td></tr>
    <tr>
      <td colspan="2" align="center">
      <textarea name="txtgallery" id="txtgallery" cols="45" rows="5"><?php echo $gallery; ?></textarea>
        <script language="javascript">
			var oEdit3=new InnovaEditor("oEdit3");
			oEdit3.width="100%";
			oEdit3.height="100";
			oEdit3.cmdAssetManager ="modalDialogShow('/extensions/editor/innovar/assetmanager/assetmanager.php',640,465)";
			oEdit3.REPLACE("txtgallery");
		</script>
      </td>
    </tr>
    <tr>
