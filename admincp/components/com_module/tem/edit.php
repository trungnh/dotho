...
Những mục đánh dấu <font color="red">*</font> là yêu cầu bắt buộc.
  <fieldset>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="3" style="border:#CCC 1px solid;">
      <tr>
        ...
        <select name="cbo_type" id="cbo_type" onchange="select_type();">
         ...
         <input type="hidden" name="txtid" id="txtid" value="<?php echo $objmodule->ID;?>" /></td>
      </tr>
      <tr>
        <td width="150" align="right" bgcolor="#EEEEEE"><strong><?php echo CTITLE;?> <font color="red">*</font></strong></td>
        <td>
          <input name="txttitle" type="text" id="txttitle" size="45" value="<?php echo $objmodule->Title;?>">
      ...
      <tr>
        ...
        <td><input name="optviewtitle" type="radio" id="radio" value="1" <?php if($objmodule->ViewTitle==1) echo "checked";?>/>
          <?php echo CYES;?>
          <input name="optviewtitle" type="radio" id="radio2" value="0" <?php if($objmodule->ViewTitle==0) echo "checked";?> />
          <?php echo CNO;?></td>
        </tr>
      <tr>
        ...
        <td>
          <select name="cbo_position" id="cbo_position">
             <?php LoadPosition();?>
             <script language="javascript">
			  cbo_Selected('cbo_position','<?php echo $objmodule->Position;?>');
			  </script>
          </select>   
        </td>
      </tr>
      <tr>
        ...
        <td><label>
          <input type="text" name="txtclass" id="txtclass" value="<?php echo $objmodule->Class;?>" />
        </label></td>
        </tr>
	  <tr>
        <td align="right" bgcolor="#EEEEEE"><strong><?php echo CPUBLIC;?>&nbsp;</strong></td>
        <td>
        <input name="optactive" type="radio" id="radio" value="1" <?php if($objmodule->isActive==1) echo "checked";?>><?php echo CYES;?>
        <input name="optactive" type="radio" id="radio2" value="0" <?php if($objmodule->isActive==0) echo "checked";?>><?php echo CNO;?></td>
      </tr>
    </table>
    </fieldset>
    <?php if($viewtype=="mainmenu" || $viewtype=="catalog"  || $viewtype=="latestnew" || $viewtype=="hotnews" || $viewtype=="othernews" || $viewtype=="html" || $viewtype=="latestpro" || $viewtype=="hotpro"  || $viewtype=="otherpro"){ ?>
    <fieldset>
    <legend><strong><?php echo "Parameter";?>:</strong></legend>
      ...
      <tr>
  	    ...
  	    <td>
        	<select name="cbo_menutype" id="cbo_menutype" onchange="document.frm_list.submit();">
			  ...
			  ?>
              <script language="javascript">
			  cbo_Selected('cbo_menutype','<?php echo $objmodule->MnuID;?>');
			  </script>
            </select>
      ...
      <tr>
  	    ...
  	    <td>
           ...
           <?php
			...
			<script language="javascript">
			  cbo_Selected('cbo_cate','<?php echo $objmodule->CatID;?>');
			  </script>
      ...
      <tr>
  	    <td width="150" align="right" bgcolor="#EEEEEE" valign="top"><strong><?php echo "Chọn nhóm sản phẩm";?> <font color="red">*</font></strong></td>
  	    <td>
        	<select name="cbo_cate" id="cbo_cate">
  	        <option value="0" title="Top"><?php echo "Chọn một nhóm sản phẩm";?></option>
           <?php
		  	if(!isset($objCata))
      ...
      <?php }else if($viewtype=="html"){?>
  	  <tr>
  	    <td colspan="2">
        <textarea name="txtcontent" id="txtcontent" cols="45" rows="5"><?php echo uncodeHTML($objmodule->HTML);?></textarea>
		<script language="javascript">
      ...
      <tr>
  	    ...
  	    <td>
        	<select name="cbo_theme" id="cbo_theme" onchange="document.frm_list.submit();">
             ...
             <script language="javascript">
			  cbo_Selected('cbo_theme','<?php echo $objmodule->Theme;?>');
			  </script>
            </select>      
        </td>
      </tr>
   ...
   <table width="100%" border="0" cellspacing="1" cellpadding="3" style="border:#CCC 1px solid;">
		...
		<style type="text/css">
          ...
          <input name="txtmenus" type="hidden" id="txtmenus" value="<?php echo trim($objmodule->Mnuids);?>" />
