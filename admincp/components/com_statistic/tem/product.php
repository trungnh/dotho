  ...
  <form id="frm_list" name="frm_list" method="post" action="">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
      <tr>
        ...
        <select name="cbo_cont" id="cbo_cont" onchange="document.frm_list.submit();">
          <option value="all">Chọn một loại sản phẩm</option>
              <?php 
			  if(!isset($objcate)) 
			  	$objcate=new CLS_CATALOG();
			  	echo $objcate->getListCatalog(0,0);
			  ?>
          <script language="javascript">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
      <tr class="header">
        ...
        <td width="30" align="center"><?php echo CNAME;?></td>
        <td align="center"  width="200"><?php echo CCATALOG;?></td>
        <td align="center" width="100"><?php echo CAUTHOR;?></td>
        <td align="center" width="100">SL còn</td>
		<td align="center">SL đã bán</td>
      </tr>
      <?php 
	   if(isset($_POST["txtCurnpage"]))
       $cur_page=$_POST["txtCurnpage"];
	  $objcont=new CLS_PRODUCTS();
	  $objcont->getAllList($strwhere);
	  $total_rows=$objcont->Numrows();
	  $objcont->listTablePro($strwhere,$cur_page,-1);
	  ?>
    </table>
  </form>
