  ...
  <form id="frm_list" name="frm_list" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
      <tr class="header">
        ...
        <td width="75" align="center"><?php echo CNAME;?></td>
        <td align="center"><?php echo CAUTHOR;?></td>
        <td align="center">Email</td>
        <td align="center"><?php echo CSITE;?></td>
        <td width="50" align="center"><?php echo CDEFAULT;?></td>
	  ...
	  $objtem=new CLS_TEM();
	  $total_rows=$objtem->Numrows($strwhere);
	  $objtem->listTableTem($strwhere,$cur_page);
	  ?>
    </table>
  </form>
