<?php
	...
	if(isset($_GET["mnuid"]))
		$mnuid=$_GET["mnuid"];
	$editmenu=new CLS_MENU();
	$editmenu->getMenuByID($mnuid);
?>
<div id="action">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" style="border:#CCC 1px solid;">
      <tr>
        ...
        <td>
	      ...
	      <input type="hidden" name="txtid" id="txtid" value="<?php echo $editmenu->ID;?>"></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#EEEEEE"><strong><?php echo CCODE;?> <font color="red">*</font></strong></td>
        <td>
          <input type="text" name="txtcode" id="txtcode" value="<?php echo $editmenu->Code;?>">
      ...
      <tr>
        ...
        <td>
        <input name="optactive" type="radio" id="radio" value="1" <?php if($editmenu->isActive==1) echo "checked";?>>
			<?php echo CYES;?>
        <input name="optactive" type="radio" id="radio2" value="0" <?php if($editmenu->isActive==0) echo "checked";?>>
			<?php echo CNO;?></td>
      </tr>
    </table>
    <fieldset>
<legend><strong><?php echo CDESC;?>:</strong></legend>
          <?php //Create_textare("txtdesc",'oEdit1');?>
            <textarea name="txtdesc" id="txtdesc" cols="45" rows="5"><?php echo $editmenu->Desc;?></textarea>
        	<script language="javascript">
