...
<div id="navitor">
    <ul>
        ...
        <li>
            <a href="#"><span><?php echo $obj_mnulang->MENUS_PRODUCTS;?></span></a>
            <ul class="submenu">
                <li class="space"><a href="index.php?com=catalogs"><span><?php echo $obj_mnulang->CATALOG;?></span></a></li>
                <li><a href="index.php?com=products"><span><?php echo $obj_mnulang->PRODUCTS;?></span></a></li>
                <li><a href="index.php?com=order"><span><?php echo $obj_mnulang->ORDER;?></span></a></li>
            </ul>
        </li>
        <li>
